...
class ControllerExtensionPaymentPaykeeper extends Controller {
	...
	public function index() {
		...
		$data['entry_deffered_order_status'] = $this->language->get('entry_deffered_order_status');
		...
		if (isset($this->request->post['payment_paykeeper_force_discounts_check'])) {
			$data['payment_paykeeper_force_discounts_check'] = $this->request->post['payment_paykeeper_force_discounts_check'];
		} else {
			$data['payment_paykeeper_force_discounts_check'] = $this->config->get('payment_paykeeper_force_discounts_check');
		}
		...
		if (isset($this->request->post['payment_paykeeper_deferred_order_status'])) {
			$data['payment_paykeeper_deferred_order_status'] = $this->request->post['payment_paykeeper_deferred_order_status'];
		} else {
			$data['payment_paykeeper_deferred_order_status'] = $this->config->get('payment_paykeeper_deferred_order_status');
		}
